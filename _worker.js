...
async function getVLESSConfig(userID2, hostName, proxyIP2) {
  try {
    ...
    const vlessTls = `vless://${userID2}@${hostName}:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2Fvless-ws#${isp} (eunsang)`;
    const vlessNtls = `vless://${userID2}@${hostName}:80?path=%2Fvless-ws&security=none&encryption=none&host=${hostName}&fp=randomized&type=ws&sni=${hostName}#${isp} (eunsang)`;
